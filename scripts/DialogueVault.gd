...
var scrow05 = {
	...
	"dialogue": [
		...
		{"text": "I remember last time you were having a bit of trouble.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": null},
...
var scrow06 = {
	...
	"dialogue_yes": [
		{"text": "Ha ha ha! Wow, that's great! I'm stealing that one. Hoo boy, thank you. Things have been tense around here, as perhaps you could tell. I've been trying my best to smile through it with a joke and a laugh, but it's not that easy sometimes. I really appreciate that you and I could share a small moment of levity like that. We don't get to connect like this with many people, so when we do, it's kind of important, you know? And I think the best way to make and maintain those connections is with a smile. Sadly, it can be a bit of a risk sometimes. Some people just want you to behave how they expect you to, or will try to take advantage of you when you meet them with kindness. That's hard. But when you get a smile back, when someone meets you on your level, that can make the risk worth it. Anyway, I've chewed your ear off for long enough. Thanks for spending some time with me.", "x_pos": rant_x_pos, "y_pos": rant_y_pos, "x_size": rant_x_size, "y_size": rant_y_size, "clip": "", "signal": ["smallen"]}
	],
	"dialogue_no": [
...
var scrow08 = {
	...
	"dialogue": [
		...
		{"text": "Hey there!", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "It's me, Jeff, the developer.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "That scarecrow's fine, don't worry about it. They don't feel any pain when I do that.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "Just wanted to pop in and check up on you.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "I really appreciate you taking the time to play my game.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "It really does mean a lot.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "How are things going? Are you enjoying it so far?", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden", "choice"]}
	],
	"dialogue_yes": [
		{"text": "Great, that's great! I'm really glad to hear that.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "To be honest, by the end, I wasn't sure anyone was going to like this game.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "Thanks again for playing.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "Okay, I'll let you get back to it. Enjoy!", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "...whoa...uh, wow.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["whiten"]},
		{"text": "That felt really bad. I didn't like that.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["whiten"]}
	],
	"dialogue_no": [
		{"text": "Oh no! I'm really sorry to hear that.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "I hope you're willing to stick it out a little longer.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "If not, don't worry about ducking out early.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "I won't take it personally.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "Thanks for giving my game a shot, and  hope it gets better.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["redden"]},
		{"text": "...whoa...uh, wow.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["whiten"]},
		{"text": "That felt really bad. I didn't like that.", "x_pos": 600, "y_pos": 100, "x_size": 400, "y_size": 400, "clip": "", "signal": ["whiten"]}
	]
}
...
func reset():
	scrow01.finished = false
	scrow02.finished = false
	scrow03.finished = false
	scrow04.finished = false
	scrow05.finished = false
	scrow06.finished = false
	scrow07.finished = false
	scrow08.finished = false
	scrow09.finished = false
	scrow10.finished = false
